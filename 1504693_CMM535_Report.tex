...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{#Divide the dataset into 60% training and 40% testing, to prevent overfitting from occurring}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{#Predict the accuracy of the c5.0 Model against the testing set}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{#Predict the accuracy of the rf Model against the testing set}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{#Show which variables are most important from the RF Model}
\hlkwd{varImpPlot}\hlstd{(RFModel}\hlopt{$}\hlstd{finalModel,}\hlkwc{main} \hlstd{=} \hlstr{'Variable Importance'}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=1\linewidth]{figure/unnamed-chunk-48-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
##  chr [1:3248] "Edible_c2" "Edible_c2" "Edible_c2" "Edible_c2" ...
##  Factor w/ 4 levels "Edible_c1","Edible_c2",..: 2 2 2 2 2 2 2 2 2 2 ...
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{#initlise results variable outside for-loop to null}
